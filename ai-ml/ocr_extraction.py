...
def _fix_ocr_errors(text):
    ...
    text = re.sub(r'S\s+O', 'S/O', text)
    text = re.sub(r'D\s+O', 'D/O', text)
    text = re.sub(r'W\s+O', 'W/O', text)
    text = re.sub(r'C\s+O', 'C/O', text)
...
def _extract_address(all_items, mid_x=None, img_w=None):
    ...
    address_text = re.sub(r'S\s+O', 'S/O', address_text)
    address_text = re.sub(r'D\s+O', 'D/O', address_text)
    address_text = re.sub(r'W\s+O', 'W/O', address_text)
    address_text = re.sub(r'C\s+O', 'C/O', address_text)
    ...
    address_text = re.sub(r'TamilNadu', 'Tamil Nadu', address_text)
    address_text = re.sub(r'AndhraPradesh', 'Andhra Pradesh', address_text)
    address_text = re.sub(r'UttarPradesh', 'Uttar Pradesh', address_text)
    address_text = re.sub(r'WestBengal', 'West Bengal', address_text)
    address_text = re.sub(r'NorthEast', 'North East', address_text)
