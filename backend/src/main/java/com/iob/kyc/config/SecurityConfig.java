    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/", "/index.html", "/PROJECT_REPORT.html", "/css/**", "/js/**", "/assets/**", "/user/**", "/admin/**", "/api/public/**", "/api/ai/healthz", "/api/ai/diagnose", "/api/ai/test-deepfake", "/api/ai/deepfake-test", "/api/config/**", "/health", "/error").permitAll()
